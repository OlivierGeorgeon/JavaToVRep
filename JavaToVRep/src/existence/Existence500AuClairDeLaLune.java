...
public class Existence500AuClairDeLaLune extends Existence500 {
	...
	protected void initExistence() {
		...
		addOrGetAbstractExperiment(i32);
	...
	public Interaction040 enactPrimitiveIntearction(Interaction030 intendedPrimitiveInteraction){
		...
		try {
			...
			*/
			...
			int eResult = Integer.parseInt(loadString);
			...
			if (retultLabel.equals(LABEL_R2)){
				String babySoundFile = "sound/c6.wav";
				if (experimentLabel.equals(LABEL_E2))
					babySoundFile = "sound/d6.wav";
				if (experimentLabel.equals(LABEL_E3))
					babySoundFile = "sound/e6.wav";
				try {
